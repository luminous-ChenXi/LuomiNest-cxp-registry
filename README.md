...
| 仓库 | 作用 |
|------|------|
| **LuomiNest-cxp-registry**（本仓库） | 索引注册表，仅维护 `index.json` |
  ...
  "plugins": [
    {
      ...
      "license": "MIT",
      "minAppVersion": "0.7.6",
      "repo": "https://github.com/luminous-ChenXi/LuomiNest-cxp-pdf-reader",
...
| ID | 名称 | 平台 | 仓库 |
|----|------|------|------|
| `cxp-pdf-reader` | PDF 智能阅读器 | fullstack | LuomiNest-cxp-pdf-reader |
